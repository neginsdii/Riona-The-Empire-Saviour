...
///   Description       : An Audio Manager that mainly manages bgm (expandable)
///   Revision History  : 1st ed. A Singleton audio manager with don't destroy on
///                     load. Can play track from any scene using GetInstance and
///                     adjust volume
///----------------------------------------------------------------------------------
